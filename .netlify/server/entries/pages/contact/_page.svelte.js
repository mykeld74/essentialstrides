...
const css$1 = {
  code: ".contactForm.svelte-qe2acb.svelte-qe2acb{display:flex;flex-direction:column;align-items:center;justify-content:center;width:calc(100% - 40px);max-width:500px;margin:30px auto;padding:20px;border:2px solid #111;border-radius:15px;background:#fff}.formBlock.svelte-qe2acb.svelte-qe2acb{width:100%;margin-top:20px;position:relative}label.svelte-qe2acb.svelte-qe2acb{position:absolute;top:0;left:20px;transform:translateY(calc(20px - 50%));transition:all 0.3s ease-in-out;color:#333;font-weight:500;pointer-events:none;margin:0;background:#fff;padding:0 10px}input.svelte-qe2acb:focus~label.svelte-qe2acb,textarea.svelte-qe2acb:focus~label.svelte-qe2acb,input.svelte-qe2acb:valid~label.svelte-qe2acb,textarea.svelte-qe2acb:valid~label.svelte-qe2acb{transform:translateY(-6px);left:20px;font-size:12px;background:#fff;padding:0 10px}input.svelte-qe2acb.svelte-qe2acb,textarea.svelte-qe2acb.svelte-qe2acb{width:100%;height:40px;border-radius:10px;border:2px solid #ccc;padding:0 20px}textarea.svelte-qe2acb.svelte-qe2acb{height:100px;padding-top:10px}.inputError.svelte-qe2acb.svelte-qe2acb{border:2px solid #800}.error.svelte-qe2acb.svelte-qe2acb{font-size:0.9em;color:#880000;margin:5px 0 0 10px}.hidden.svelte-qe2acb.svelte-qe2acb{display:none}button.svelte-qe2acb.svelte-qe2acb{width:100%;height:60px;border-radius:10px;border:2px solid var(--primaryColor);background:var(--primaryColor);color:var(--fontColor);font-weight:500;font-size:clamp(22px, 3.5vw, 30px);cursor:pointer;transition:all 0.3s ease-in-out}button.svelte-qe2acb.svelte-qe2acb:hover{background:#fff;color:#111}",
  map: null
};
const ContactForm = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  ...
  let { nameError = false } = $$props;
  let { phoneError = false } = $$props;
  let { emailError = false } = $$props;
  let { messageError = false } = $$props;
  if ($$props.nameError === void 0 && $$bindings.nameError && nameError !== void 0)
    $$bindings.nameError(nameError);
  if ($$props.phoneError === void 0 && $$bindings.phoneError && phoneError !== void 0)
    $$bindings.phoneError(phoneError);
  if ($$props.emailError === void 0 && $$bindings.emailError && emailError !== void 0)
    $$bindings.emailError(emailError);
  if ($$props.messageError === void 0 && $$bindings.messageError && messageError !== void 0)
    $$bindings.messageError(messageError);
  $$result.css.add(css$1);
  return `<form name="${"contact"}" id="${"contact"}" class="${"contactForm svelte-qe2acb"}" data-netlify="${"true"}"><input type="${"hidden"}" name="${"form-name"}" value="${"contact"}" class="${"svelte-qe2acb"}">
	<input class="${"hidden svelte-qe2acb"}" name="${"bot-field"}">
	<div class="${"formBlock svelte-qe2acb"}"><input type="${"text"}" name="${"name"}" id="${"name"}" class="${(0, import_chunks.e)((0, import_chunks.b)(nameError ? "inputError" : ""), true) + " svelte-qe2acb"}" required${(0, import_chunks.f)("value", fields.name, 0)}>
		<label for="${"name"}" class="${"svelte-qe2acb"}">Name</label>
		<p class="${"error svelte-qe2acb"}">${(0, import_chunks.e)(errors.name)}</p></div>
	<div class="${"formBlock svelte-qe2acb"}"><input type="${"tel"}" name="${"phone"}" id="${"phone"}" class="${(0, import_chunks.e)((0, import_chunks.b)(phoneError ? "inputError" : ""), true) + " svelte-qe2acb"}" required${(0, import_chunks.f)("value", fields.phone, 0)}>
		<label for="${"phone"}" class="${"svelte-qe2acb"}">Phone</label>
		<p class="${"error svelte-qe2acb"}">${(0, import_chunks.e)(errors.phone)}</p></div>
	<div class="${"formBlock svelte-qe2acb"}"><input type="${"email"}" name="${"email"}" id="${"email"}" required class="${(0, import_chunks.e)((0, import_chunks.b)(emailError ? "inputError" : ""), true) + " svelte-qe2acb"}"${(0, import_chunks.f)("value", fields.email, 0)}>
		<label for="${"email"}" class="${"svelte-qe2acb"}">Email</label>
		<p class="${"error svelte-qe2acb"}">${(0, import_chunks.e)(errors.email)}</p></div>
	<div class="${"formBlock svelte-qe2acb"}"><textarea name="${"message"}" id="${"message"}" class="${(0, import_chunks.e)((0, import_chunks.b)(messageError ? "inputError" : ""), true) + " svelte-qe2acb"}" required>${""}</textarea>
		<label for="${"message"}" class="${"svelte-qe2acb"}">Message</label>
		<p class="${"error svelte-qe2acb"}">${(0, import_chunks.e)(errors.message)}</p></div>
	<div class="${"formBlock svelte-qe2acb"}"><button type="${"submit"}" class="${"svelte-qe2acb"}">Submit</button></div></form>

${``}`;
});
const _page_svelte_svelte_type_style_lang = "";
const css = {
  code: ".contentContainer.svelte-10k3sl0{min-height:calc(100vh - 100px);margin-top:20px}",
  map: null
};
const Page = (0, import_chunks.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Contact Us | Essential Strides</title>`, ""}`, ""}

<div class="${"contentContainer svelte-10k3sl0"}"><h1>Please complete the form below and we will get back to you soon.</h1>
	${(0, import_chunks.v)(ContactForm, "ContactForm").$$render($$result, {}, {}, {})}
</div>`;
});
